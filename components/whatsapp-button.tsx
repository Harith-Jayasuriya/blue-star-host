...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-3 px-3 py-2 bg-white rounded-lg shadow-lg text-sm font-medium text-gray-700 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        Chat with us
      </span>
    </button>
  )
